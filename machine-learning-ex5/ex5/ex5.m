...
[Xtest_poly, mu, sigma] = featureNormalize(Xtest_poly);  % Normalize
Xtest_poly = [ones(size(Xtest, 1), 1), Xtest_poly];      % Add Ones

[error_test,grad] = linearRegCostFunction(Xtest_poly, ytest, theta, 0); 

fprintf(['Error_test at lambda = 3: %f '...
...
for i = 1:repeat
    for j = 1:m
        ...
        [Jval, gradval] = linearRegCostFunction(X_poly_val_rand, yval_rand, theta, 0);
